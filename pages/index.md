...
Security attributes are part of the Beacon v2 [Framework](https://github.com/ga4gh-beacon/beacon-framework-v2). The file [`beaconConfiguration.json`](https://github.com/ga4gh-beacon/beacon-framework-v2/blob/main/configuration/beaconConfigurationSchema.json) defines the schema of the Json file that includes core aspects of a Beacon instance configuration: the third section defines the security:
